...
public final class Range<T extends Comparable<? super T>> {
    ...
    private <S> S checkNotNull(S lower, String string)
    {
		if(lower==null)throw new IllegalArgumentException(string);
		return lower;
	}
    ...
    @Override
    public int hashCode() {
        return mLower.hashCode()*mUpper.hashCode()+mLower.hashCode();
    }
